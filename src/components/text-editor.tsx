...
function LinkComponent({ editor, children }: { editor: Editor; children: ReactNode }) {
  ...
  const [isLinkPopover, setIsLinkPopoverOpen] = useState(false);
  ...
  return (
    <Popover open={isLinkPopover} onOpenChange={setIsLinkPopoverOpen}>
...
const ToolBar = ({editor} : {editor: Editor}) => {
 ...
 return (  
        <div className={"bg-background sticky top-0 z-10 flex flex-wrap items-center gap-1 border-b p-2"}>
            ...
            value={
                editorState.isHeading2 ? "heading2" : editorState.isHeading3 ? "heading3" : editorState.isHeading4 ? "heading4" : editorState.isHeading5 ? "heading5" : editorState.isHeading6 ? "heading6" : "paragraph"
            }
            >
      ...
      <Toggle 
       ...
       <Toggle 
        ...
        aria-label="Toggle blockquote">
            <Quote className=' bg-border mx-1 h-4 w-4'/>            
        </Toggle>
